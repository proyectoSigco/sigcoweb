                    ...
                    <form id="defaultForm" action="../controllers/controladorMetasUsuarios.php" method="post">
                        ...
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="cedula">Seleccionar empleado*</label>
                                    <select class="form-control select2" name="cedula" id="cedula">
                                        ...
                                        foreach ($lista as $recorrer ) { ?>
                                            <option value="<?php echo $recorrer['cc'] ?>"><?php echo $recorrer['cc']." | ".$recorrer['Nombres']." ".$recorrer['Apellidos']." | ".$recorrer['Cargo'] ?></option>
                                            <?php
                                        }
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="meta" id="meta">
                                        <option disabled selected>Seleccionar</option>
                                        <?php
                                        $metas=$facade->listarMetas();foreach ($metas as $mostrar ) { ?>
                                            <option value="<?php echo $mostrar['IdMeta'] ?>">
                                                <?php echo 'Id: '.$mostrar['IdMeta'].' | Tipo: '.$mostrar['Tipo'].' | Cantidad: '.$mostrar['CantidadValor'].' | Fecha Inicio: '.$mostrar['FechaInicio'].' | Fecha fin: '.$mostrar['FechaFin'] ?></option>
                                            <?php
                                        }
