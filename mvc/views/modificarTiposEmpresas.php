...
<div class="wrapper">
    ...
    if (isset($_GET['IdTipo'])) {
        $tiposFac = new TiposEmpresasFacade();
        $tipo = $tiposFac->obtenerTipoEmpresa($_GET['IdTipo']);
        ?>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Modificar tipo de empresa</li>
                </ol>
            </section>
            ...
            <section class="content">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form
                            action="../controllers/TiposEmpresasController.php?controlar=modificar&IdTipo=<?php echo $_GET['IdTipo']; ?>"
                            method="post" class="validacion" id="formValidacion">

                            <!-- general form elements disabled -->
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Modificar tipos de empresas</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <!-- text input -->
                                    <div class="form-group">
                                        <p>
                                            ...
                                            modificar un tipo de empresa.<br><br>
                            ...
                            <div class="box box-default">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="IdTipo">Id. del tipo de empresa (único)</label>
                                        <input type="text" name="IdTipo" id="IdTIpo" class="form-control"
                                               value="<?php echo $tipo['IdTipo']; ?>" readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label for="NombreTipo">Nombre del tipo de empresa*</label>
                                        <input type="text" name="NombreTipo" id="NombreTipo" class="form-control"
                                               value="<?php echo $tipo['NombreTipo']; ?>" autofocus required
                                               tabindex="1"/>
                                    </div>
